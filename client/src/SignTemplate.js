...
const SignTemplate = (props) => {
    ...
    return (
        <Grid container component="main" className={classes.root}>
            <Grid xs={false} sm={4} md={5} className={classes.backgroundImage} >
                <Grid className={classes.linearGradient}>
                    <Grid
                        ...
                        <svg width="67px" height="67px" viewbox="0 0 67 67" version="1.1" style={{paddingTop: '5%'}}>
                            <g id="chat">
            ...
            <Grid xs={12} sm={8} md={7} elevation={6}>
